  ...
  return (
    ...
    >
      <div className="space-y-1">
        <h4 className="text-sm font-semibold">Asistente de hoja de palilleo</h4>
        <p className="text-sm text-muted-foreground">
          Podemos preparar las hojas con ISO, CLASE, Ø y SCH desde los
          metadatos/BOM. Las longitudes PALILLO se introducen manualmente
          mirando el isométrico.
        </p>
        <p
            ...
            <div className="flex flex-wrap items-start gap-3">
              ...
              <div className="min-w-0 flex-1 space-y-2">
                <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
                  <span className="font-medium">{suggestion.lineIdentifier}</span>
      ...
      <form action={formAction}>
        ...
        <input type="hidden" name="suggestionsPayload" value={payload} readOnly />
